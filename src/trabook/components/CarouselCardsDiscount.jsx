...
import { useAxiosPlansWithDiscount } from '../../hooks/useAxiosPlansWithDiscount';
import { TrabookContext } from '../../context/TrabookContext';
import { Card } from './';

export const CarouselCardsDiscount = () => {
  useAxiosPlansWithDiscount();
  const { trabook } = useContext(TrabookContext);
  const { plansWithDiscount } = trabook;
